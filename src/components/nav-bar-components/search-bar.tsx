...
const SearchBar: FC = () => {
  return (
    <div className="flex flex-row justify-between space-x-[9.5rem] bg-[#21242D] px-[1.56rem] py-[1rem] border-[0.05rem] border-[rgba(249,_249,_249,_0.10)] rounded-[0.75rem] w-full lg:w-[22.69rem]">
