...
const Card: FC<MovieData> = ({
  ...
  return (
    <div className="relative flex-shrink-0 w-[14.81rem] h-[18.63rem] flex flex-col justify-center items-center overflow-hidden rounded-[1.25rem] bg-[linear-gradient(180deg,_rgba(22,_24,_30,_0.00)_0%,_rgba(22,_24,_30,_0.70)_61.28%),_linear-gradient(0deg,_rgba(22,_24,_30,_0.40)_0%,_rgba(22,_24,_30,_0.40)_100%)]">
      <div className="bg-[linear-gradient(0deg,_rgba(22,_24,_30,_0.50)_0%,_rgba(22,_24,_30,_0.50)_100%)] w-full h-full">
        <img
      ...
      <div className="absolute z-40 flex flex-col justify-between items-start pt-[1.31rem] px-[0.62rem] pb-[0.62rem] w-full h-full text-white bg-[linear-gradient(0deg,_rgba(22,_24,_30,_0.40)_0%,_rgba(22,_24,_30,_0.40)_100%)]">
